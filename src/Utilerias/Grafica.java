...
import com.ike.grafica.DAOGrafica;
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            if (clPagina.equalsIgnoreCase("6") || clPagina.equalsIgnoreCase("27")){
                ...
                strSQL.append( sentenciaSQL.trim().replaceAll("%20"," ") );
                ...
                if (clPagina.equalsIgnoreCase("23")){
                    ...
                    if(clPagina.equalsIgnoreCase("17")||clPagina.equalsIgnoreCase("19")||clPagina.equalsIgnoreCase("20")||clPagina.equalsIgnoreCase("21")){
                        ...
                        return ("<IMG SRC=..\\SGrafica?type=" + param + "&dsCampo=" + permisografica.getDsCampo() + "&dsCampoCan=" + permisografica.getDsCampoCan() +  "&Tipo=" + permisografica.getTipo() + "&Pagina=" + clPagina.toString().trim() + " BORDER=1 WIDTH=550 HEIGHT=320/>");
                    }
                }
            }
