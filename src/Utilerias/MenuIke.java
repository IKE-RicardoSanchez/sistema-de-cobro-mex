 ...
 * MenuIke.java
 *
 * Created on 19 de octubre de 2004, 09:44 AM
 */
...
public class MenuIke {
    ...
    public static void doMenuIke(String pclUsrApp, final StringBuffer strMenu) {
        ...
        strSql.append("sp_tmkgcA_sys_GetMenues ").append(pclUsrApp).append(",1");
        ...
        try{
            ...
            while (rsMenu.next()){
                ...
                strSql.append("sp_tmkgcA_sys_GetMenues ").append(pclUsrApp).append(",2,").append("'").append(rsMenu.getString("dsMenu")).append("'");
                ...
                while (rsSubMenu1.next()){
                    ...
                    if (rsSubMenu1.getString("NombrePaginaWeb") == null){
                        ...
                        // genera el submenu 2
                        strSql.append("sp_tmkgcA_sys_GetMenues ").append(pclUsrApp).append(",2,").append("'").append(rsSubMenu1.getString("dsMenu")).append("'");
                        ...
                        while (rsSubMenu2.next()) {
                            if (rsSubMenu2.getString("NombrePaginaWeb") == null){
                                ...
                                // genera el submenu 3
                                strSql.append("sp_tmkgcA_sys_GetMenues ").append(pclUsrApp).append(",2,").append("'").append(rsSubMenu2.getString("dsMenu")).append("'");
                                ...
                                while (rsSubMenu3.next()) {
                                    ...
                                    /*if (rsSubMenu2.isLast()) {
                                         tv.nodes.item(i).childNodes.item(j).childNodes.item(k).imageUrl = "images/dotlast.gif";
                                    } else {
                                         tv.nodes.item(i).childNodes.item(j).childNodes.item(k).imageUrl = "images/dot.gif";
                                    }*/
                                    l++;
                                }
                                rsSubMenu3.close();
                        ...
                        /*if (rsSubMenu1.isLast()) {
                            tv.nodes.item(i).childNodes.item(j).imageUrl = "images/dotlast.gif";
                        } else {
                            tv.nodes.item(i).childNodes.item(j).imageUrl = "images/dot.gif";
                        }*/
                    }
                    j++;
                }
