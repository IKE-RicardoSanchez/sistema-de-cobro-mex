...
<html>
    ...
    <body class="cssBody">
       ...
       %>
        ...
        /*---Validacion para HSBC 20140906 cqv*/
        /*------------------------------------------------*/
        StringBuffer StrSql1 = new StringBuffer();
            
        if(session.getAttribute("proyecto").equals("ASIST") || session.getAttribute("proyecto").equals("HCRED") || session.getAttribute("proyecto").equals("HCPLA") || session.getAttribute("proyecto").equals("HDEBI")){
            if(!session.getAttribute("proyecto").equals("HDEBI")){
                StrSql1.append("st_TMKGC_ValidacionCobroHSBC '").append(session.getAttribute("proyecto")).append("', 1");
            }else{
                StrSql1.append("st_TMKGC_ValidacionCobroHSBC_Debi '").append(session.getAttribute("proyecto")).append("'");
            }
        }else{
                System.out.println("Entra y vacio para el resto de proyectos");
             }
