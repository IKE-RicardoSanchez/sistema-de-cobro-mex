...
<html>
    ...
    <body class="cssBody">
        ...
        StrSql.append("st_TMKGCA_ReporteVentasNuevasDiarias ").append(1);
            System.out.println(StrSql.toString());
        ...
        StringBuffer SQL = new StringBuffer();
                SQL.append("st_TMKGCA_ReporteVentasNuevasDiarias ").append(0);
                ResultSet query= UtileriasBDF.rsSQLNP(SQL.toString());

                    while(query.next()){
                        complemento= query.getString("Ventas").toString();
                    }
