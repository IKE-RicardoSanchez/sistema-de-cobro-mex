        ...
        if(session.getAttribute("proyecto")!=null)
         {
          ...
          <table border="1">
            ...
            if(session.getAttribute("proyecto").equals("BXPN") || session.getAttribute("proyecto").equals("BMXP") ){
                StringBuffer StrSalida = new StringBuffer();
                StrSql.append("sp_tmkgcA_ValidaCobroMx '").append(session.getAttribute("proyecto")).append("', 9");
           ...
           <table border="0" class="btm">
               <tr>
                      <td><center><h4 >Codigo rechazo</h4></center></td>
                  </tr>
                  <tr>
                      <td><%=StrSalida%></td>
                  </tr>
