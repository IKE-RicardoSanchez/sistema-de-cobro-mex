<%@ page contentType="text/html; charset=iso-8859-1" language="java"
         import="java.sql.ResultSet,Utilerias.UtileriasBDF,Seguridad.SeguridadC,Utilerias.Captcha,Utilerias.Upload" errorPage="" %>
<html>
    <head>
    ...
    <body class="cssBody">
        ...
        <div id="tipoetiqueta" style="position:absolute; z-index:3; left:160px;">
            <a id="tipoRetiquetaPreval" class="cssAzul" style="visibility:hidden;">Respuesta de Pre Validación<br>(ej: R_Preval_[Sufijo]_[Fecha envio]) </a><br>
            <a id="tipoRetiquetaResp" class="cssAzul" style="visibility:hidden;">Respuesta de Cobro<br>(ej: R_[Sufijo]_L[No lote]_[Nombre archivo])</a>
        </div>
