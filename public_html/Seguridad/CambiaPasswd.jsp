...
<%
    ...
    if (session.getAttribute("clUsrCambiaPwd")!=null){
        ...
        %>Solicitud de Cambio registrado fuera de sesión <%
        return;
    }
...
<%  }  
    ...
    out.println("<INPUT type='password' size=10 id='Confirma' name='Confirma' value='' tooltipText='Confirma tu nueva Contraseña (8 Caracteres)<br> <font size=1>Debe coincidir con la nueva contraseña.</font>' ></INPUT>");
...
<script type="text/javascript">
    ...
    function fnValidaC(){
        ...
        if (document.all.Confirma.value==''){
            ...
            if (LC<8) { msgVal=msgVal + " El campo \"Confirmación\" tiene MENOS caracteres de los permitidos."}
        }
        if(msgVal!=""){
            return(msgVal);
        }
