...
<%  
    ...
    StrSQL.append("FROM tmkgcA_cMenu M ");
    StrSQL.append("LEFT JOIN tmkgcA_cPaginaWeb P ON P.clPaginaWeb = M.clPaginaWeb ");
    StrSQL.append("LEFT JOIN tmkgcA_cMenu PAR ON PAR.clMenu = M.clMenuParent ");
    StrSQL.append("LEFT JOIN tmkgcA_cPaginaWeb REL ON REL.clPaginaWeb = M.clPaginaRel ");
    ...
    if (rs.next()) {
        ...
        <%=MyUtil.ObjComboC("Pagina Web","clPaginaWeb",rs.getString("NombreLogicoWeb"),true,true,270,100,"","select clPaginaWeb,NombreLogicoWeb from tmkgcA_cPaginaWeb","","",40,true,true)%>
        <%=MyUtil.ObjComboC("Menu Padre","clMenuParent",rs.getString("dsParent"),true,true,50,140,"","select clMenu, dsMenu dsMenuParent from tmkgcA_cMenu where clPaginaWeb is Null","","",40,true,true)%>
        ...
        <%=MyUtil.ObjComboC("Pagina Web","clPaginaWeb","",true,true,270,100,"","select clPaginaWeb,NombreLogicoWeb from tmkgcA_cPaginaWeb","","",40,true,true)%>
        <%=MyUtil.ObjComboC("Menu Padre","clMenuParent","",true,true,50,140,"","select clMenu, dsMenu from tmkgcA_cMenu","","",40,true,true)%>
